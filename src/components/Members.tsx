...
function getFallBackImage(name: string) {
  const fallBackImages: Record<string, string> = {
    "Alessandro Cavaliere": "/pfp/galaxea.png",
    ...
    "Giovanni Iannaccone": "/pfp/giovanni.png",
  };
            ...
            {member.categories.map((category) => {
              ...
              return (
                <Badge
                  ...
                  variant="secondary"
                  className={
                    "text-white transition-colors hover:bg-[color:var(--btn-regular-bg-hover)]"
                  }
      ...
      try {
        ...
        const results = await Promise.all(
          members.map(async (member) => {
            ...
            return {
              key: member.github,
              image: image || getFallBackImage(member.name),
            };
          }),
        );
