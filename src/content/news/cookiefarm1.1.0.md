---
title: CookieFarm v1.1.0
published: 2025-05-16
description: CookieFarm v1.1.0 is here! This update brings new features, improvements, and bug fixes to enhance your A/D CTF experience. Check out the release notes for details on what's new and how to get started with the latest version of CookieFarm.
...
<img src="https://github.com/ByteTheCookies/CookieFarm/blob/main/assets/logo_mucca.png?raw=true" width="300" height="300" alt="CookieFarm Logo" style="float: right; margin-left: 20px; margin-bottom: 20px;"/>
...
![SCHEMA](https://github.com/ByteTheCookies/CookieFarm/blob/main/assets/arch_farm.png?raw=true)
